<header class="admin-topbar fixed left-0 right-0 top-0 z-20 h-16 bg-[#24448d] text-white shadow lg:left-[296px]">
    <div class="admin-topbar-inner flex h-full items-center gap-4 px-4">
        ...
        <a href="{{ route('admin.dashboard', absolute: false) }}" class="admin-brand flex h-9 min-w-[300px] items-center rounded-tl-full rounded-tr-2xl bg-[#3f70c9] px-5 text-2xl font-bold tracking-wide shadow-inner">
            TNT SOL
        </a>
